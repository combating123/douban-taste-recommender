...
**Files:**
- Modify: `C:\Users\11616\douban-taste-recommender\tests\test_ui_html.py`

**Interfaces:**
- Consumes: `INDEX_HTML`
- Produces: tests for premium media UI markers.

- [ ] Add tests requiring `heroShowcase`, `railWall`, `media-rail`, `posterFallback`, `safePosterImg`, `person-chip`, `电影`, `电视剧`, `动漫`.
...
- [ ] Always expose `精选`、`电影`、`电视剧`、`动漫` category buttons/rails when data exists.
