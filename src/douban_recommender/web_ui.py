...
<script>
const state = { step:1, items:[], ratedItems:[], counts:{}, errors:[], diagnostics:[], recommendations:[], sections:[], activeSection:'全部', ratingsCsv:'', candidatesCsv:'', profile:null };
