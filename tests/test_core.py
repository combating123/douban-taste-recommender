...
class CoreRecommendationTests(unittest.TestCase):
    def test_sample_recommendations(self):
        ...
        self.assertTrue("隐秘的角落" in titles or "坠落的审判" in titles)
        self.assertTrue(all(r.score > 0 for r in recs))
